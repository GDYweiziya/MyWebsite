...
export default function ProjectCard({ name, description, imageUrl, githubUrl }: ProjectCardProps) {
  ...
  return (
    <div className={`group relative rounded-xl overflow-hidden transition-all duration-300 cursor-pointer ${
      isDark 
        ...
        : 'bg-white/80 border border-gray-200/50 hover:border-indigo-300/50'
